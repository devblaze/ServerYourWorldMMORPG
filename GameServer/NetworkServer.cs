...
namespace ServerYourWorldMMORPG.GameServer
{
	public class NetworkServer : INetworkServer
	{
		...
		public void Initialize()
		{
			...
			_tcpServer = new TCPServer(ApplicationSettings.IpAddress, ApplicationSettings.TcpPort, ApplicationSettings.MaxPlayers);
			_udpServer = new UDPServer(ApplicationSettings.UdpPort);
		}
